...
module parameters
 ...
 character (len=128),parameter ::  outputpath='./' &
  ...
  integer, parameter :: nytot=4 !400 OT
  integer, parameter :: nztot=4
  !
#ifdef MPIP
  !   mpi array of processors
  integer, parameter :: mpicol=16, mpirow=1,mpirowz=1
  ...
  real, parameter :: cv=1., gamma=(cv+1.)/cv   !BW
...
!  real, parameter :: xphys=1. !FOR ORZAG_TANG
  ...
  real, parameter :: tmax    = 0.21  !3.5 !*day/tsc
  real, parameter :: dtprint = 0.02  !0.05 !*day/tsc
